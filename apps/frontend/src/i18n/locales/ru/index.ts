 ...
 * Один файл на пространство (параллельная работа FE-пакетов без общих файлов);
 * i18next по-прежнему видит одно пространство 'translation': t('lecture.x') не меняется.
 */
export const ru = {
